      ...
      <ScrollView contentContainerStyle={[styles.container, { minHeight: '100%' }]}> 
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => router.push({ pathname: '../../(tabs)/TurkiyeLig/team-squad', params: { teamId: teamInfo.id, season: 2024 } })}
          >
            <LinearGradient
          ...
          <TouchableOpacity
            activeOpacity={0.85}
            style={[styles.modernButton, { borderColor: teamColor }]}
            onPress={() => router.push({ pathname: '../../(tabs)/TurkiyeLig/team-fixtures', params: { teamId: teamInfo.id } })}
          >
            <LinearGradient
              colors={[teamColor, 'rgba(255,255,255,0.7)']}
              start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
