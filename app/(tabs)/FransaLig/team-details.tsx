...
export default function FransaTeamDetailsScreen() {
  ...
  const teamColor = (teamInfo.colors && teamInfo.colors.primary) || '#007bff';
  return (
    <LinearGradient
      colors={['#e0ecff', '#fff']}
      style={{ flex: 1 }}
    ...
    >
      ...
      <ScrollView contentContainerStyle={[styles.container, { minHeight: '100%' }]}> 
        ...
        <Text style={styles.pageTitle}>Fransa Ligi Takım Detayları</Text>
        ...
        {teamInfo.national ? (
          <Text style={[styles.national, { backgroundColor: '#007bff20', color: '#007bff', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 2, alignSelf: 'center', marginTop: 6, fontWeight: 'bold'}]}>Milli Takım</Text>
        ) : (
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            activeOpacity={0.85}
            style={[styles.modernButton, { borderColor: (teamInfo.colors && teamInfo.colors.primary) || '#007bff' }]}
            onPress={() => router.push({ pathname: '../../(tabs)/FransaLig/team-squad', params: { teamId: teamInfo.id, season: 2024 } })}
          >
            <LinearGradient
              colors={[(teamInfo.colors && teamInfo.colors.primary) || '#007bff', 'rgba(255,255,255,0.7)']}
          ...
          <TouchableOpacity
            activeOpacity={0.85}
            style={[styles.modernButton, { borderColor: (teamInfo.colors && teamInfo.colors.primary) || '#007bff' }]}
            onPress={() => router.push({ pathname: '../../(tabs)/FransaLig/team-fixtures', params: { teamId: teamInfo.id } })}
          >
            <LinearGradient
              colors={[(teamInfo.colors && teamInfo.colors.primary) || '#007bff', 'rgba(255,255,255,0.7)']}
              start={{ x: 0, y: 0 }} end={{ x: 1, y: 1 }}
